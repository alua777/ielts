...
import { Clock3, RefreshCw, Target, Trophy } from 'lucide-react';
...
export default function QuickStatsCard({ averageTime, attemptsCount, improvement }) {
  return (
    <ResultsPanel title="Quick Stats" className="min-h-[305px]">
